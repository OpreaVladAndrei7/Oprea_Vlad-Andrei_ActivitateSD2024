...
void filtrare(Heap heap, int pozRad) {
	int fs = pozRad * 2 + 1;           //fiul din stanga al nodului
	int fd = pozRad * 2 + 2;           //fiul din dreapta al nodului
	int pozMax = pozRad;
...
void main() {
	...
	//de preferat extragem in cadrul unor obiecte pe care putem sa le stergem dupa afisare
